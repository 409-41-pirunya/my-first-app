...
st.markdown ("# :rad[🏋️ คำนวณค่าดัชนีมวลกาย BMI]")
...
height_cm = st.number_input("กรอกส่วนสูงของคุณ (เซนติเมตร):", min_vule=1.0, vulue=1.0)

#ส่วนที่ 3 สร้างปุ่มกดจำนวน
...
#ส่วนที่ 4 แปลค่าผล BMI ตามเกณฑ์
  if bmi < 18.5:
    st.warning("⚠️ คุณมีน้ำหนักน้อยกว่าเกณฑ์ (ผอม)")
  elif 18.5 <= bmi < 23.0:
    st.success("🎉 คุณเริ่มมีน้ำหนักอยู่ในเกณฑ์ปกติ (สุขภาพดี)")
  elif 23.0 <= bmi < 25.0:
...
st.drivider()
st.write("นางสาว ภิรัญญษ เจี่ยเจริญตระกูล เลขที่41 ม.4/9")
